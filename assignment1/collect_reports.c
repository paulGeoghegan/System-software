...
void collect_reports(void) {
    ...
    syslog(LOG_INFO,"Moving reports to reporting directory");

	char names[4][14] = {"warehouse","manufacturing","•	sales","distribution"};
    char source[] = "/home/paul/System-software/assignment1/uploads/";
    char destination[] = "/home/paul/System-software/assignment1/reporting/";
	struct dirent *dir;
